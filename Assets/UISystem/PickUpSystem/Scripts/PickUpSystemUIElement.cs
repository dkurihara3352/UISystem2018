...
namespace UISystem.PickUpUISystem{
	...
	public class PickUpSystemUIEConstArg: UIElementConstArg, IPickUpSystemUIEConstArg{
		public PickUpSystemUIEConstArg(IUIManager uim, IPickUpSystemProcessFactory pickUpSystemProcessFactory, IPickUpSystemUIElementFactory pickUpSystemUIElementFactory, IUIImage image, IPickUpSystemUIA pickUpSystemUIA): base(uim, pickUpSystemProcessFactory, pickUpSystemUIElementFactory, pickUpSystemUIA, image){
