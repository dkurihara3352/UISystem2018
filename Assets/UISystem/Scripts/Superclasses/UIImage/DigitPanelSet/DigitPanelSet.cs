...
namespace UISystem{
	...
	public class DigitPanelSetConstArg: UIElementConstArg, IDigitPanelSetConstArg{
		public DigitPanelSetConstArg(IUIManager uim, IUIAdaptor uia, IUIImage image, IUITool tool, int digitPlace, Vector2 panelDim, Vector2 padding): base(uim, uia, image, tool){
