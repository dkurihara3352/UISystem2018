...
namespace UISystem{
	...
	public class TurnImageDarknessProcess: AbsInterpolatorProcess<IImageDarknessInterpolator>, ITurnImageDarknessProcess{
		public TurnImageDarknessProcess(IProcessManager processManager, ProcessConstraint rateOfChangeConstraint, float rateOfChange, float diffThreshold, IUIImage image, float targetDarkness, bool useSpringT): base(processManager, rateOfChangeConstraint, rateOfChange, diffThreshold, useSpringT, null){
			thisImage = image;
