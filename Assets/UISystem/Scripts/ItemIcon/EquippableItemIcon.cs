...
namespace UISystem{
	...
	public class EquippableItemIconConstArg: ItemIconConstArg, IEquippableItemIconConstArg{
		public EquippableItemIconConstArg(IUIManager uim, IEquippableItemIconAdaptor uia, IItemIconImage itemIconImage, IEquipTool tool, IDragImageImplementor dragImageImplementor , IEquippableIITAManager eqpIITAM, IEquippableUIItem item, IEqpIITransactionStateEngine eqpIITAStateEngine, IItemIconPickUpImplementor pickUpImplementor, IItemIconEmptinessStateEngine emptinessStateEngine): base(uim, uia, itemIconImage, tool, dragImageImplementor, eqpIITAM, item, eqpIITAStateEngine, pickUpImplementor, emptinessStateEngine){
		}
	}
}
