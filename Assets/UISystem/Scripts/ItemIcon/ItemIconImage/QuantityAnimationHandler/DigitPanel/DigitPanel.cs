...
namespace UISystem{
	...
	public class DigitPanelConstArg: UIElementConstArg, IDigitPanelConstArg{
		public DigitPanelConstArg(IUIManager uim, IDigitPanelAdaptor digitPanelAdaptor, IUIImage image, IUITool tool, Vector2 panelDim, float localPosY): base(uim, digitPanelAdaptor, image, tool){
